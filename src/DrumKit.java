...
// gl;gjfg;lkgb3rjol
    ...
    frame.add(panel);
   	 // 7. Downlocompframe.ad an image of a drum from the Internet. Drop it into your Eclipse project under "default package".
...
if(drumLabelWithImage.equals(e.getSource())) {
   		 // 17. ...use the playSound method to play a drum sound.
playSound("drum.wav");
 
}
if(cymbalLabelWithImage.equals(e.getSource())) {
		 // 17. ...use the playSound method to play a drum sound.
